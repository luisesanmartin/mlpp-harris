...
def discretize(df, column):
    ...
    observation belongs to a certain quintile of the column provided.
    Each dummy has the name of the column + a number indicating the quintile.
    ...
    for i in range(1, N_SUBSETS + 1):
        ...
        df.loc[df[column] < mini, column + str(i)] = 0
        df.loc[df[column] > maxi, column + str(i)] = 0
